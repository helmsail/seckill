...
@RocketMQMessageListener(topic = "seckill-close-order-topic", consumerGroup = "seckill-close-order-consumer-group")
public class SeckillCloseOrderConsumer implements RocketMQListener<String> {
